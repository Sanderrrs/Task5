...
INSERT INTO tpp_product (id, product_code_id, client_id, type, number, priority, date_of_conclusion, start_date_time, end_date_time, days, penalty_rate, nso, threshold_amount, requisite_type, interest_rate_type, tax_rate, reasone_close, state) VALUES (1, 1, 1, '0', '001/2023_NSO', 1, '2023-12-01 03:00:00.000000', '2024-03-18 18:47:37.105000', null, null, 12.300000190734863, 11.199999809265137, 10.100000381469727, null, 'прогрессивная', 9.899999618530273, null, 'OPEN');

SELECT nextval('tpp_product_id_seq');